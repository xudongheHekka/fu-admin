...
# 压测配置
URL = "https://api-meeting.weizhiyanchina.com/web/act/team/familys"
PARAMS = {
    "np": "",
    "actCode": "WOMANWAR2025",
    "size": "10"
}
HEADERS = {
...
# 注意：虽然原始curl命令包含了请求体，但这是一个GET请求，通常GET请求不应该有请求体
# 如果API确实需要在GET请求中包含请求体，请取消下面的注释
# PAYLOAD = {
#     "act_code": "WOMAN2025",
#     "module_name": "女神化妆盒",
#     "amount": 10,
...
def make_request():
    ...
    try:
        ...
        # 如果API确实需要在GET请求中包含请求体，请使用下面的代码替代上面的行
        # response = requests.request("GET", URL, params=PARAMS, headers=HEADERS, json=PAYLOAD, timeout=10)
...
def save_results():
    ...
    filename = f"get_loadtest_results_{timestamp}.txt"
